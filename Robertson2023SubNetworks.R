#this script is for creating the subnetwork from Fig 3
#created by limiting promoter motifs to specified family name
...
fimoTargets <- fimo %>% 
  ...
  filter(RegulatorGeneID %in% motifsSub$GeneID | TargetGeneID %in% motifsSub$GeneID | 
           Motif_ID %in% motifsSub$Motif_ID)
